...
export const updateSetting = createAsyncThunk("admin/setting/update", async (payload) => {
...
export const handleSetting = createAsyncThunk("admin/setting/handleSwitch", async (payload) => {
    ...
    return apiInstance.put(`admin/setting/handleSwitch?type=${payload?.type}`,payload.data)
})
